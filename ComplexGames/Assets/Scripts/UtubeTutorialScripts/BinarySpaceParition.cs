...
{
   public class BinarySpaceParition 
    {
        private RoomNode rootNode;
        public RoomNode RootNode { get => rootNode; }
        public BinarySpaceParition(int dungeonWidth, int dungeonLength)
        {
        ...
        public List<RoomNode> PrepareNodesCollection(int maxIterations, int roomWidthMin, int roomLengthMin)
        {
            ...
            while (iterations < maxIterations && graph.Count > 0)
            {
                ...
                {
                    SplitIt(currentNode, listToReturn, roomLengthMin, roomWidthMin, graph);
                }
            }
        ...
        private void SplitIt(RoomNode currentNode, List<RoomNode> listToReturn, int roomLengthMin, int roomWidthMin, Queue<RoomNode> graph)
        {
